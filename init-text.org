...
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "<f6> \\") (lambda () (interactive) (insert "‚Äñ")))
(global-set-key (kbd "<f6> n") (lambda () (interactive) (insert "‚Ñï")))
(global-set-key (kbd "<f6> r") (lambda () (interactive) (insert "‚Ñù")))
#+END_SRC
...
(save-excursion				;save the current point
  (replace-string "ì" "\"" nil (point-min) (point-max))
  (replace-string "¬î" "\"" nil (point-min) (point-max))
  (replace-string "í" "'" nil (point-min) (point-max))
  (replace-string "ó" "--" nil (point-min) (point-max)) ; multi-byte
  (replace-string "ù" "\"" nil (point-min) (point-max))
  (replace-string "ë" "\"" nil (point-min) (point-max))
  (replace-string "í" "'" nil (point-min) (point-max))
  (replace-string "°\"" "\"" nil (point-min) (point-max))
  (replace-string "°≠" "..." nil (point-min) (point-max))
  (replace-string "¥" "\"" nil (point-min) (point-max))
  (replace-string "ª" "<<" nil (point-min) (point-max))
  (replace-string "«" "'" nil (point-min) (point-max))
  (replace-string "»" "\"" nil (point-min) (point-max))
  (replace-string "È" "e'" nil (point-min) (point-max)) ;; &eacute;
  (replace-string "Û" "-" nil (point-min) (point-max))
))

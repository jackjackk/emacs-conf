...
**** Tools ([[file:init-mod-magit.org][magit]], [[file:init-mod-exec-path-from-shell.org][exec-path-from-shell]], [[file:init-mod-helm-dash.org][helm-dash]], +[[file:init-mod-eimp.org][eimp]]+, [[file:init-mod-spray.org][spray]]) 
#+BEGIN_SRC emacs-lisp
                      magit

...
Widen view from narrowed heading with "S".
#+BEGIN_SRC emacs-lisp
(add-to-list 'org-speed-commands-user
             '("S" widen))
#+END_SRC
...
By default focus on daily agenda.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "capture.org")
                ...
                ("c" "I was procrastinating" entry (file+headline "journal-procrastination.org" "I was procrastinating instead of")

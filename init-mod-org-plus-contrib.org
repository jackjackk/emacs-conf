...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files (list "~/org/projects.org" "~/org/capture.org"))
#+END_SRC

When agenda loads Org files for the first time, don't ignore startup options.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
(setq org-stuck-projects '("LEVEL=2" ("NEXT" "WAITING") nil ""))
#+END_SRC

Custom commands.
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-custom-commands
        '(("a" "Agenda, Next, Project, Waiting, Stuck, Someday"
           (
            (agenda "" )
            (todo "NEXT" )
            (todo "PROJECT" )
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "capture.org")
                ...
                ("c" "I was procrastinating" entry (file+headline "~/org/personal-procrastination.org" "I was procrastinating instead of")
                ...
                ("z" "I was lazy" entry (file+headline "~/org/personal-procrastination.org" "I was procrastinating instead of")
                ...
                ("p" "Protocol" entry (file+headline "notes.org" "Inbox")
                    "* %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n\n\n%?")
                ("L" "Protocol Link" entry (file+headline "capture.org" "inbox")
...
#+BEGIN_SRC emacs-lisp
  (setq org-refile-targets (quote ((org-agenda-files :todo . "PROJECT"))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;              ((x-family-fonts "Sans Serif")    '(:family "Sans Serif"))
    ...
    (custom-theme-set-faces
     ...
     `(org-level-2 ((t (,@headline ,@variable-tuple :height 1.2 :weight bold))))
  ...
  ; '(variable-pitch ((t (:family "Source Sans Pro" :height 180 :weight light))))
   '(fixed-pitch ((t ( :family "Inconsolata" :slant normal :weight normal :width normal)))))
